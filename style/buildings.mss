...
@building-major-fill: darken(@building-fill, 0%);  // Lch(75, 8, 67)
@building-major-line: darken(@building-major-fill, 15%);  // Lch(61, 13, 65)
@building-major-z15: darken(@building-major-fill, 0%);  // Lch(70, 9, 66)
@building-major-z14: darken(@building-major-fill, 0%);  // Lch(66, 11, 65)
